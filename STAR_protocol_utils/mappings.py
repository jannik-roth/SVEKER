...
def get_ecfp4_bit_info(smi: str, n_bits: int = 2048, radius: int = 2) -> dict:
    """
    ...
    dict_bitInfo = {}
    AllChem.GetMorganFingerprintAsBitVect(mol, radius=radius, useChirality=False, bitInfo=dict_bitInfo, nBits=n_bits)
    return dict_bitInfo
...
def get_atom_wise_weight_map(mol, weights, mol_size, cmap='coolwarm', return_png: bool = True):
    """
    Generate
    ...
    draw2d.drawOptions().padding = 0
    draw2d.drawOptions().setBackgroundColour((1,1,1,0))
    ...
    clrs = [tuple(cmap.get_under()), (1, 1, 1, 0), tuple(cmap.get_over())]
    ...
    draw2d.drawOptions().scalingFactor = 20
